...
LANGUAGES = {
    'tr': {
        'display_name': "Türkçe",
        'window_title': "Kick Chat Overlay Ayarları",
        'lang_label': "Dil:",
        'channel_label': "Kick Kanal Adı:",
        'resolution_label': "Çözünürlük (Genişlik x Yükseklik):",
        'font_size_label': "Yazı Tipi Boyutu (px):",
        'position_label': "Pencere Konumu:",
        'hotkey_label': "Konum Döngü Kısayolu:",
        'hotkey_example': "Örn: ctrl+shift+x, alt+k",
        'nudge_hotkeys_label': "Pencere Kaydırma Kısayolları",
        'nudge_labels': ["Yukarı:", "Aşağı:", "Sol:", "Sağ:"],
        'start_button': "AYARLARI KAYDET & BAŞLAT",
        'error_title': "Hata",
        'error_invalid_channel': "Lütfen geçerli bir kanal adı girin.",
        'error_invalid_resolution': "Lütfen geçerli bir sayısal değer girin.",
        'positions': ["Üst-Sağ", "Üst-Sol", "Alt-Sağ", "Alt-Sol", "Orta-Sağ", "Orta-Sol"]
    },
    'en': {
        'display_name': "English",
        'window_title': "Kick Chat Overlay Settings",
        'lang_label': "Language:",
        'channel_label': "Kick Channel Name:",
        'resolution_label': "Resolution (Width x Height):",
        'font_size_label': "Font Size (px):",
        'position_label': "Window Position:",
        'hotkey_label': "Position Cycle Hotkey:",
        'hotkey_example': "e.g., ctrl+shift+x, alt+k",
        'nudge_hotkeys_label': "Window Nudge Hotkeys",
        'nudge_labels': ["Up:", "Down:", "Left:", "Right:"],
        'start_button': "SAVE SETTINGS & LAUNCH",
        'error_title': "Error",
        'error_invalid_channel': "Please enter a valid channel name.",
        'error_invalid_resolution': "Please enter a valid numeric value.",
        'positions': ["Top-Right", "Top-Left", "Bottom-Right", "Bottom-Left", "Middle-Right", "Middle-Left"]
    },
    'fr': {'display_name': 'Français', 'window_title': "Paramètres de l'overlay de chat Kick", 'lang_label': 'Langue :', 'channel_label': 'Nom de la chaîne Kick :', 'resolution_label': 'Résolution (Largeur x Hauteur) :', 'font_size_label': 'Taille de la police (px) :', 'position_label': 'Position de la fenêtre :', 'hotkey_label': 'Raccourci de Cycle de Position :', 'hotkey_example': 'ex: ctrl+shift+x, alt+k', 'nudge_hotkeys_label': 'Raccourcis de Déplacement de Fenêtre', 'nudge_labels': ['Haut :', 'Bas :', 'Gauche :', 'Droite :'], 'start_button': 'ENREGISTRER & LANCER', 'error_title': 'Erreur', 'error_invalid_channel': 'Veuillez entrer un nom de chaîne valide.', 'error_invalid_resolution': 'Veuillez entrer une valeur numérique valide.', 'positions': ['Haut-Droite', 'Haut-Gauche', 'Bas-Droite', 'Bas-Gauche', 'Milieu-Droite', 'Milieu-Gauche']},
    'ru': {'display_name': 'Русский', 'window_title': 'Настройки оверлея чата Kick', 'lang_label': 'Язык:', 'channel_label': 'Название канала Kick:', 'resolution_label': 'Разрешение (Ширина x Высота):', 'font_size_label': 'Размер шрифта (пикс.):', 'position_label': 'Позиция окна:', 'hotkey_label': 'Горячая клавиша цикла:', 'hotkey_example': 'пример: ctrl+shift+x, alt+k', 'nudge_hotkeys_label': 'Клавиши перемещения окна', 'nudge_labels': ['Вверх:', 'Вниз:', 'Влево:', 'Вправо:'], 'start_button': 'СОХРАНИТЬ И ЗАПУСТИТЬ', 'error_title': 'Ошибка', 'error_invalid_channel': 'Пожалуйста, введите корректное название канала.', 'error_invalid_resolution': 'Пожалуйста, введите корректное числовое значение.', 'positions': ['Справа-Сверху', 'Слева-Сверху', 'Справа-Снизу', 'Слева-Снизу', 'Справа-Посередине', 'Слева-Посередине']},
    'zh': {'display_name': '简体中文', 'window_title': 'Kick 聊天悬浮窗设置', 'lang_label': '语言:', 'channel_label': 'Kick 频道名称:', 'resolution_label': '分辨率 (宽度 x 高度):', 'font_size_label': '字体大小 (像素):', 'position_label': '窗口位置:', 'hotkey_label': '位置切换快捷键:', 'hotkey_example': '例如: ctrl+shift+x, alt+k', 'nudge_hotkeys_label': '窗口微调快捷键', 'nudge_labels': ['上:', '下:', '左:', '右:'], 'start_button': '保存并启动', 'error_title': '错误', 'error_invalid_channel': '请输入有效的频道名称。', 'error_invalid_resolution': '请输入有效的数值。', 'positions': ['右上', '左上', '右下', '左下', '右中', '左中']},
    'ko': {'display_name': '한국어', 'window_title': 'Kick 채팅 오버레이 설정', 'lang_label': '언어:', 'channel_label': 'Kick 채널 이름:', 'resolution_label': '해상도 (너비 x 높이):', 'position_label': '창 위치:', 'hotkey_label': '위치 순환 단축키:', 'hotkey_example': '예: ctrl+shift+x, alt+k', 'nudge_hotkeys_label': '창 이동 단축키', 'nudge_labels': ['위:', '아래:', '왼쪽:', '오른쪽:'], 'start_button': '저장하고 시작하기', 'error_title': '오류', 'error_invalid_channel': '유효한 채널 이름을 입력하세요.', 'error_invalid_resolution': '유효한 숫자 값을 입력하세요.', 'positions': ['오른쪽-위', '왼쪽-위', '오른쪽-아래', '왼쪽-아래', '오른쪽-중간', '왼쪽-중간']}
}
...
class KickOverlayApp:
    ...
    def load_settings(self):
        defaults = {
            ...
            "position_key": "top_left", "cycle_hotkey": "-", "language": "en",
            "hotkey_up": "up", "hotkey_down": "down",
            "hotkey_left": "left", "hotkey_right": "right"
        }
    ...
    def create_overlay_window(self):
        ...
        # *** DEĞİŞİKLİK BURADA ***
        # Filtre listesi isteğiniz doğrultusunda güncellendi.
        js_code_to_inject = f"""
        setTimeout(() => {{
            ...
            const pathsToRemove = [
                '/html/body/div/div[1]/div/div[2]/div[2]/div',
                '/html/body/div/div[1]/div/div[1]',
                '/html/body/div/div[2]/div/div/div',
                '/html/body/div/div[1]/div/div[2]/div[1]/div[2]/div/div[26]/div/div[1]',
                '/html/body/div/div[1]/div/div[2]/div[1]/div[2]/div/div[26]/div/div[2]',
                '/html/body/div/div[1]/div/div[2]/div[1]/div[2]/div/div[26]/div/div[3]'
            ];
